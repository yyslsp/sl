...
// let fs = require('fs');
// let pathLib = require('path');//图片地址路径
// let bcrypt = require('../../utils/bcrypt');//引入加密解密
// let mgdb = require('../../utils/mgdb');//查询数据
...
//   let icon = '/upload/user/421bd2c2030a76bc4c696b5fefc9ba38.png';//默认头像
